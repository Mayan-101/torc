What has been done
1. Parameters can be entered, Error logic
2. Phase 1 questions (1, 2, 3*, 4*)
3. Market based on Random Walk
4. Redo-ing changes in parameters after launch 
5. Video-Embeds for explainers (for now the source is Youtube)
